...
$CMD_PERF sched timehist > $LOGS_DIR/timehist_general.log 2> /dev/null
(( PERF_EXIT_CODE += $? ))
...
# 0 is pid for idle
$CMD_PERF sched timehist --pid=0,$REGEX_PERF_PID,$REGEX_SLEEP_PID > $LOGS_DIR/timehist_pid.log 2> /dev/null
PERF_EXIT_CODE=$?
...
# 0 is tid for idle
$CMD_PERF sched timehist --tid=0,$REGEX_PERF_TID,$REGEX_SLEEP_TID > $LOGS_DIR/timehist_tid.log 2> /dev/null
(( PERF_EXIT_CODE += $? ))
...
$CMD_PERF sched timehist -s > $LOGS_DIR/timehist_summary.log 2> /dev/null
PERF_EXIT_CODE=$?
...
$CMD_PERF sched timehist -S > $LOGS_DIR/timehist_with-summary.log 2> /dev/null
PERF_EXIT_CODE=$?
...
$CMD_PERF sched timehist -w > $LOGS_DIR/timehist_wakeups.log 2> /dev/null
PERF_EXIT_CODE=$?
...
$CMD_PERF sched timehist -M > $LOGS_DIR/timehist_migration.log 2> /dev/null
PERF_EXIT_CODE=$?
...
$CMD_PERF sched timehist -n > $LOGS_DIR/timehist_next.log 2> /dev/null
PERF_EXIT_CODE=$?
...
$CMD_PERF sched timehist -I > $LOGS_DIR/timehist_idle-hist.log 2> /dev/null
PERF_EXIT_CODE=$?
...
$CMD_PERF sched timehist --state > $LOGS_DIR/timehist_state.log 2> /dev/null
PERF_EXIT_CODE=$?
