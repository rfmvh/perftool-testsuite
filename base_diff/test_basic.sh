...
REGEX_LINE_DELTA="$REGEX_SEP[\+\-]$RE_NUMBER%$REGEX_SEP(?:$RE_FILE_NAME)|(?:\[[\w\.]+\])$REGEX_SEP\[[\.kH]\]\s[\w\.\-]+"
REGEX_LINE_BOTH="$RE_NUMBER$REGEX_SEP[\+\-]$RE_NUMBER%$REGEX_SEP(?:$RE_FILE_NAME)|(?:\[[\w\.]+\])$REGEX_SEP\[[\.kH]\]\s[\w\.\-]+"
